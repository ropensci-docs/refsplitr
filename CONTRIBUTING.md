...
you have found a bug, create an associated issue and illustrate the bug
...
- We recommend that you create a Git branch for each pull request
  (PR).  
- Look at the Github Actions and AppVeyor build status before and after
  making changes.
...
Please note that the `refsplitr` project is released with a [Contributor
Code of
Conduct](https://docs.ropensci.org/refsplitr/CODE_OF_CONDUCT.md). By
